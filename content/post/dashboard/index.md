...
# The Solution
Some may privilege chance, others will also try to make educated guesses on the grounds of chronology, addressees, authors, origin of the archival fonds, language, etc. Yet how about *looking* at all these variables simultaneously? Can we improve the quality of our conjectures using interactive data visualization? My experience shows that, when graphed, the metadata researchers usually gather in a spreadsheet can significantly increase situational awareness and decision-making in the archive. Indeed, visualizing metadata may reveal patterns or clues about the archive's structure.
...
# Next steps
Perhaps more importantly, this dashboard can be repurposed as a visual index, when the critical edition of the letters will be published on-line. It will be an alternative entry point, from where readers will be able to browse the data. For reasons of confidentiality, I can only show a redacted screenshot, but I will release the complete dashboard next year. In the meantime a prototype will be soon available. Stay tuned!